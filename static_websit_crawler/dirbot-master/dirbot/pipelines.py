...
class MySQLStorePipeline(object):
    ...
    def _conditional_insert(self, tx, item):
        try:  
            classNameShort=str(self.dataDemo.__getTableName__('tableName'))
            primaryKey =  str(self.dataDemo.__getPrimaryKey__('primaryKey'))
            ...
            itemNameValue = {}
            primyKeyHaveNull = 0
            for jsonitem in self.dataDemo.__getItems__('items'):
